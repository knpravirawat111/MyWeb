...
import { personalInfo, footerQuote, socialLinks } from "@/lib/data";
    ...
    <footer className="bg-slate-900 dark:bg-slate-950 text-white">
      ...
      <div className="border-b border-slate-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <p className="text-lg sm:text-xl text-slate-300 italic max-w-2xl mx-auto">
              "{footerQuote.text}"
            </p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <Link href="#home" className="inline-block text-xl font-bold mb-4">
